  ...
  return (
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard title="Total Users" value="2,543" icon={Users} trend={12.5} />
        <StatCard title="Revenue" value="$45,231" icon={DollarSign} trend={8.2} />
        <StatCard title="Sales" value="1,205" icon={ShoppingBag} trend={-3.4} />
        <StatCard title="Growth" value="24.8%" icon={TrendingUp} trend={15.3} />
      </div>
